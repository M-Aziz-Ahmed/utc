                        ...
                        {loading ? (
                            ...
                            recentVehicles.map(v => {
                                ...
                                return (
                                    ...
                                    >
                                        <div style={{width:40, height:40, borderRadius:8, background:'#F3F4F6', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, overflow:'hidden'}}>
                                            {v.mainImage ? (
                                                <img src={v.mainImage} alt={getVehicleName(v)} style={{width:'100%', height:'100%', objectFit:'cover'}} />
                                            ) : (
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="font-semibold truncate" style={{fontSize:13, color:'#111827'}}>
                                                {getVehicleName(v)}
                                                {v.year ? <span style={{fontWeight:500, color:'#6B7280'}}> · {v.year}</span> : null}
                                            </p>
